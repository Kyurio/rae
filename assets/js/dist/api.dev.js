...
var app = new Vue({
  ...
  methods: {
     ...
     *
     */
    newformRepresentates: function newformRepresentates() {
    ...
    deleteformRepresentantes: function deleteformRepresentantes() {
     ...
     *
     */
    grabarResena: function grabarResena() {
      if (!this.reseña) {
    ...
    checkFormPersonaNatural: function checkFormPersonaNatural() {
      this.errors = [];
      ...
      if (!this.errors.length) {
        this.GrabarPersonaNatural(); //return true;
      }
    },
    checkFormEmpresa: function checkFormEmpresa() {
      this.errors = [];

      if (!this.input_fecha_informe_sociedad || !this.input_rol || !this.input_tipo_empresa || !this.input_razon_social || !this.rut || !this.apellido_paterno || !this.apellido_materno || !this.nombres || !this.sexo || !this.carnet_client || !this.fecha_nacimient || !this.estado_civil || !this.direccion_particular || !this.pais || !this.region || !this.comuna || this.input_nacionalidad || !this.nacionalidad || !this.profecion || !this.profecion || !this.telefono_contacto || !this.celular || !this.direccion_comercial || !this.email || !this.giro || !this.mayores_clientes || !this.observaciones) {
    ...
    classObjectError: function classObjectError() {
